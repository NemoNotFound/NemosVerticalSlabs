...
public class LootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        this.addDrop(ModBlocks.TUFF_VERTICAL_SLAB, slabDrops(ModBlocks.TUFF_VERTICAL_SLAB));
        this.addDrop(ModBlocks.POLISHED_TUFF_VERTICAL_SLAB, slabDrops(ModBlocks.POLISHED_TUFF_VERTICAL_SLAB));
        this.addDrop(ModBlocks.TUFF_BRICK_VERTICAL_SLAB, slabDrops(ModBlocks.TUFF_BRICK_VERTICAL_SLAB));
