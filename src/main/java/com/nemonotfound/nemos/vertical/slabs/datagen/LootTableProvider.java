...
import com.nemonotfound.nemos.vertical.slabs.world.level.block.VerticalSlabBlock;
...
public class LootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().unaffected());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().exposed());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().weathered());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().oxidized());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().unaffected());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().exposed());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().weathered());
        addVerticalSlabDrops(VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().oxidized());
