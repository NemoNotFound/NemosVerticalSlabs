...
public class ModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(@NotNull BlockModelGenerators blockModelGenerators) {
        ...
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().unaffected(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().unaffected());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().exposed(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().exposed());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().weathered(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().weathered());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().oxidized(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.weathering().oxidized());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().unaffected(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().unaffected());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().exposed(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().exposed());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().weathered(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().weathered());
        generateVerticalSlabBlockModel(blockModelGenerators, Blocks.CUT_COPPER.weathering().oxidized(), VerticalSlabBlocks.CUT_COPPER_VERTICAL_SLABS.waxed().oxidized());
