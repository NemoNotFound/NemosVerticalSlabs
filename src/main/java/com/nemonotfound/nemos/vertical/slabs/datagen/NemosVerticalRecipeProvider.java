...
public class NemosVerticalRecipeProvider extends FabricRecipeProvider {
    ...
    public NemosVerticalRecipeProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> providerCompletableFuture, GenerationTarget target) {
    ...
    protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.@NotNull Provider provider, @NotNull RecipeOutput recipeOutput) {
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                if (target == GenerationTarget.MAIN) {
                ...
                if (target == GenerationTarget.MOSSY) {
                    ...
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_BIRCH_VERTICAL_SLAB, MossyItems.MOSSY_BIRCH_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_JUNGLE_VERTICAL_SLAB, MossyItems.MOSSY_JUNGLE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_ACACIA_VERTICAL_SLAB, MossyItems.MOSSY_ACACIA_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_DARK_OAK_VERTICAL_SLAB, MossyItems.MOSSY_DARK_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_MANGROVE_VERTICAL_SLAB, MossyItems.MOSSY_MANGROVE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_CHERRY_VERTICAL_SLAB, MossyItems.MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_PALE_OAK_VERTICAL_SLAB, MossyItems.MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_BAMBOO_VERTICAL_SLAB, MossyItems.MOSSY_BAMBOO_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, MossyItems.MOSSY_BAMBOO_MOSAIC);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_CRIMSON_VERTICAL_SLAB, MossyItems.MOSSY_CRIMSON_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.MOSSY_WARPED_VERTICAL_SLAB, MossyItems.MOSSY_WARPED_PLANKS);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_STONE_VERTICAL_SLAB, MossyItems.MOSSY_STONE);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.MOSSY_COBBLED_DEEPSLATE);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_DEEPSLATE_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.MOSSY_DEEPSLATE_TILES);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_TUFF_VERTICAL_SLAB, MossyItems.MOSSY_TUFF);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_TUFF_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.MOSSY_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_BRICKS);

                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_STONE_VERTICAL_SLAB, MossyItems.MOSSY_STONE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.MOSSY_COBBLED_DEEPSLATE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_DEEPSLATE_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.MOSSY_DEEPSLATE_TILES, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_TUFF_VERTICAL_SLAB, MossyItems.MOSSY_TUFF, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_TUFF_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.MOSSY_BRICK_VERTICAL_SLAB, MossyItems.MOSSY_BRICKS, 2);

                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_OAK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_SPRUCE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_SPRUCE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_BIRCH_VERTICAL_SLAB, MossyItems.PALE_MOSSY_BIRCH_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_JUNGLE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_JUNGLE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_ACACIA_VERTICAL_SLAB, MossyItems.PALE_MOSSY_ACACIA_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_DARK_OAK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_DARK_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_MANGROVE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_MANGROVE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_CHERRY_VERTICAL_SLAB, MossyItems.PALE_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_PALE_OAK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_BAMBOO_VERTICAL_SLAB, MossyItems.PALE_MOSSY_BAMBOO_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, MossyItems.PALE_MOSSY_BAMBOO_MOSAIC);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_CRIMSON_VERTICAL_SLAB, MossyItems.PALE_MOSSY_CRIMSON_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_WARPED_VERTICAL_SLAB, MossyItems.PALE_MOSSY_WARPED_PLANKS);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_STONE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_STONE);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_COBBLED_DEEPSLATE);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_DEEPSLATE_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_DEEPSLATE_TILES);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.PALE_MOSSY_TUFF);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_TUFF_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.PALE_MOSSY_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_BRICKS);

                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_STONE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_STONE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_COBBLED_DEEPSLATE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_DEEPSLATE_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.PALE_MOSSY_DEEPSLATE_TILES, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.PALE_MOSSY_TUFF, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_TUFF_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.PALE_MOSSY_BRICK_VERTICAL_SLAB, MossyItems.PALE_MOSSY_BRICKS, 2);

                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_OAK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_SPRUCE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_SPRUCE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_BIRCH_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_BIRCH_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_JUNGLE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_JUNGLE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_ACACIA_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_ACACIA_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_DARK_OAK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_DARK_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_MANGROVE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_MANGROVE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_CHERRY_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_PALE_OAK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_BAMBOO_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_BAMBOO_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_BAMBOO_MOSAIC);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_CRIMSON_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_CRIMSON_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_WARPED_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_WARPED_PLANKS);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_STONE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_STONE);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_COBBLED_DEEPSLATE);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_DEEPSLATE_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_DEEPSLATE_TILES);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_TUFF);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_TUFF_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.CRIMSON_MOSSY_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_BRICKS);

                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_STONE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_STONE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_COBBLED_DEEPSLATE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_DEEPSLATE_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_DEEPSLATE_TILES, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_TUFF, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_TUFF_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.CRIMSON_MOSSY_BRICK_VERTICAL_SLAB, MossyItems.CRIMSON_MOSSY_BRICKS, 2);

                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_OAK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_SPRUCE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_SPRUCE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_BIRCH_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_BIRCH_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_JUNGLE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_JUNGLE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_ACACIA_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_ACACIA_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_DARK_OAK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_DARK_OAK_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_MANGROVE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_MANGROVE_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_CHERRY_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_PALE_OAK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_CHERRY_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_BAMBOO_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_BAMBOO_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_BAMBOO_MOSAIC_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_BAMBOO_MOSAIC);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_CRIMSON_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_CRIMSON_PLANKS);
                    createWoodenVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_WARPED_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_WARPED_PLANKS);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_STONE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_STONE);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_COBBLED_DEEPSLATE);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_DEEPSLATE_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_DEEPSLATE_TILES);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_TUFF);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_TUFF_BRICK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_TUFF_BRICKS);
                    createVerticalSlabRecipe(VerticalSlabItems.WARPED_MOSSY_BRICK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_BRICKS);

                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.WARPED_MOSSY_STONE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_STONE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.WARPED_MOSSY_COBBLED_DEEPSLATE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_COBBLED_DEEPSLATE, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.WARPED_MOSSY_DEEPSLATE_BRICK_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_DEEPSLATE_BRICKS, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.WARPED_MOSSY_DEEPSLATE_TILE_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_DEEPSLATE_TILES, 2);
                    this.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, VerticalSlabItems.WARPED_MOSSY_TUFF_VERTICAL_SLAB, MossyItems.WARPED_MOSSY_TUFF, 2);
                ...
                if (target == GenerationTarget.BIOMES_O_PLENTY) {
                ...
                if (target == GenerationTarget.BIOMES_WEVE_GONE) {
