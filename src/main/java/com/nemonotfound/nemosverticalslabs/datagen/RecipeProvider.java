    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.STONE_VERTICAL_SLAB, Items.STONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.COBBLESTONE_VERTICAL_SLAB, Items.COBBLESTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.MOSSY_COBBLESTONE_VERTICAL_SLAB, Items.MOSSY_COBBLESTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.SMOOTH_STONE_VERTICAL_SLAB, Items.SMOOTH_STONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.STONE_BRICK_VERTICAL_SLAB, Items.STONE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.MOSSY_STONE_BRICK_VERTICAL_SLAB, Items.MOSSY_STONE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.GRANITE_VERTICAL_SLAB, Items.GRANITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_GRANITE_VERTICAL_SLAB, Items.POLISHED_GRANITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.DIORITE_VERTICAL_SLAB, Items.DIORITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_DIORITE_VERTICAL_SLAB, Items.POLISHED_DIORITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.ANDESITE_VERTICAL_SLAB, Items.ANDESITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_ANDESITE_VERTICAL_SLAB, Items.POLISHED_ANDESITE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.COBBLED_DEEPSLATE_VERTICAL_SLAB, Items.COBBLED_DEEPSLATE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_DEEPSLATE_VERTICAL_SLAB, Items.POLISHED_DEEPSLATE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.DEEPSLATE_BRICK_VERTICAL_SLAB, Items.DEEPSLATE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.DEEPSLATE_TILE_VERTICAL_SLAB, Items.DEEPSLATE_TILES);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_VERTICAL_SLAB, Items.TUFF);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_TUFF_VERTICAL_SLAB, Items.POLISHED_TUFF);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_BRICK_VERTICAL_SLAB, Items.TUFF_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.BRICK_VERTICAL_SLAB, Items.BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.MUD_BRICK_VERTICAL_SLAB, Items.MUD_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.SANDSTONE_VERTICAL_SLAB, Items.SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.SMOOTH_SANDSTONE_VERTICAL_SLAB, Items.SMOOTH_SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.CUT_SANDSTONE_VERTICAL_SLAB, Items.CUT_SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.RED_SANDSTONE_VERTICAL_SLAB, Items.RED_SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.SMOOTH_RED_SANDSTONE_VERTICAL_SLAB, Items.SMOOTH_RED_SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.CUT_RED_SANDSTONE_VERTICAL_SLAB, Items.CUT_RED_SANDSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.PRISMARINE_VERTICAL_SLAB, Items.PRISMARINE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.PRISMARINE_BRICK_VERTICAL_SLAB, Items.PRISMARINE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.DARK_PRISMARINE_VERTICAL_SLAB, Items.DARK_PRISMARINE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.NETHER_BRICK_VERTICAL_SLAB, Items.NETHER_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.RED_NETHER_BRICK_VERTICAL_SLAB, Items.RED_NETHER_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.BLACKSTONE_VERTICAL_SLAB, Items.BLACKSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_BLACKSTONE_VERTICAL_SLAB, Items.POLISHED_BLACKSTONE);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_BLACKSTONE_BRICK_VERTICAL_SLAB, Items.POLISHED_BLACKSTONE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.END_STONE_BRICK_VERTICAL_SLAB, Items.END_STONE_BRICKS);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.PURPUR_VERTICAL_SLAB, Items.PURPUR_BLOCK);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.QUARTZ_VERTICAL_SLAB, Items.QUARTZ_BLOCK);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.SMOOTH_QUARTZ_VERTICAL_SLAB, Items.SMOOTH_QUARTZ);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.CUT_COPPER_VERTICAL_SLAB, Items.CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.EXPOSED_CUT_COPPER_VERTICAL_SLAB, Items.EXPOSED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.WEATHERED_CUT_COPPER_VERTICAL_SLAB, Items.WEATHERED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.OXIDIZED_CUT_COPPER_VERTICAL_SLAB, Items.OXIDIZED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.WAXED_CUT_COPPER_VERTICAL_SLAB, Items.WAXED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.WAXED_EXPOSED_CUT_COPPER_VERTICAL_SLAB, Items.WAXED_EXPOSED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.WAXED_WEATHERED_CUT_COPPER_VERTICAL_SLAB, Items.WAXED_WEATHERED_CUT_COPPER);
                this.offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModItems.WAXED_OXIDIZED_CUT_COPPER_VERTICAL_SLAB, Items.WAXED_OXIDIZED_CUT_COPPER);
            }
