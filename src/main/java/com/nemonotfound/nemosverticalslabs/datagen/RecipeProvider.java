...
public class RecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        createVerticalSlabRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_VERTICAL_SLAB, Ingredient.ofItems(Items.TUFF));
        createVerticalSlabRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_TUFF_VERTICAL_SLAB, Ingredient.ofItems(Items.POLISHED_TUFF));
        createVerticalSlabRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_BRICK_VERTICAL_SLAB, Ingredient.ofItems(Items.TUFF_BRICKS));
        ...
        VanillaRecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_VERTICAL_SLAB, Items.TUFF);
        VanillaRecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.POLISHED_TUFF_VERTICAL_SLAB, Items.POLISHED_TUFF);
        VanillaRecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, ModItems.TUFF_BRICK_VERTICAL_SLAB, Items.TUFF_BRICKS);
    ...
    public static void createVerticalSlabRecipe(RecipeExporter exporter, RecipeCategory category, ItemConvertible output, Ingredient input) {
